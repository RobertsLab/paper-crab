...
NEED TO FIGURE OUT HOW TO KEEP SAMPLES IN ORDER ALONG THE BOTTOM!!
```{r}
...
top10 <- order(rowMeans(counts(deseq2.dds, normalized = TRUE)),
               decreasing = TRUE)[1:10] #average counts for each gene and select top 10 most abundant genes
pheatmap(assay(ntd)[top10,], scale = "row")
```
