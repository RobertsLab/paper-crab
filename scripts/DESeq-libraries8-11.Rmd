...
```{r}
heatmapcolors <- RColorBrewer::brewer.pal(11, "BrBG")
```

```{r}
pheatmap(noz_inftempdegs_counts_match.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapcolors, fontsize_col = 20, fontsize_row = 12)
```
