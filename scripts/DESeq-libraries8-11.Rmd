...
```{r}
pheatmap(noz_inftempdegs_counts_match.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapPurpleOrange, fontsize_col = 20, fontsize_row = 12)
```
...
```{r}
pheatmap(noz_contrtempdegs_counts_match.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapPurpleOrange, fontsize_col = 20, fontsize_row = 12)
```
...
```{r}
results <- pheatmap(noz_inftempdegs_counts_match.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapPurpleOrange, fontsize_col = 20, fontsize_row = 12)
```
...
```{r}
results2 <- pheatmap(noz_contrtempdegs_counts_match.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapPurpleOrange, fontsize_col = 20, fontsize_row = 12)
```
...
```{r}
inftemp.res.clusts4 <- contrasttemp.clust
...
Make rownames of contrtempdegs_counts_match.heatmap as column called "Trinity_ID"
```{r}
contrast_temp.res <- contrtempdegs_counts_match.heatmap
Trinity_ID <- rownames(contrast_temp.res)
rownames(contrast_temp.res) <- NULL
final_contrast_temp.res <- cbind(Trinity_ID, contrast_temp.res)
head(final_contrast_temp.res)
```



`join` with contrtempdegs_counts_match.heatmap 
```{r}
inftemp.clust.degs <- left_join(final_inftemp.res.clusts4, final_contrast_temp.res, by = "Trinity_ID")
