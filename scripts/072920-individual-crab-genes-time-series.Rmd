...
```{r}
pheatmap(crabA_heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapRdGy, fontsize_col = 12, fontsize_row = 12)
```
...
```{r}
Aheatmap <- pheatmap(crabA_heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapRdGy, fontsize_col = 12, fontsize_row = 12)
```
...
```{r}
clusters <- data.frame(cluster = ifelse(clusters == 1, "cluster 1", ifelse(clusters == 2, "cluster 2", ifelse(clusters == 3, "cluster 3", ifelse(clusters ==4, "cluster 4", ifelse(clusters == 5, "cluster 5", ifelse(clusters == 6, "cluster 6", ifelse(clusters == 7, "cluster 7", "cluster 8"))))))))
head(clusters)
```

```{r}
pheatmap(crabA_heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", annotation_row = clusters, show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 80, legend = TRUE, color = heatmapRdGy, fontsize_col = 12, fontsize_row = 12)
```
