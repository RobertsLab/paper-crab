...
# Notes:
1. Count data probably needs to be transformed in some way. I think the infection status DEG list count data is already transformed somehow...? 
2. Need to decide which genes to use in maps. I just picked some somewhat random Trinity_IDs for the maps below to practice. 
